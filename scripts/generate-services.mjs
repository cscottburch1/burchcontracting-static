...
function seoHead({ title, description, canonical, ogImage = '/images/og-default.jpg' }) {
...
${service.additionalCosts
  ...
  const calculatorButton = service.calculator
    ? `            <a href="/calculator/${service.calculator}" class="bg-white hover:bg-slate-50 text-blue-700 border-2 border-blue-700 px-8 py-4 rounded-lg font-semibold text-center transition-colors">Calculate Your Cost</a>`
    : ''
